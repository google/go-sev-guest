...
type Report struct {
	...
	LaunchMitVector  uint64 `protobuf:"varint,30,opt,name=launch_mit_vector,json=launchMitVector,proto3" json:"launch_mit_vector,omitempty"`
	CurrentMitVector uint64 `protobuf:"varint,31,opt,name=current_mit_vector,json=currentMitVector,proto3" json:"current_mit_vector,omitempty"`
}
...
func (x *Report) GetLaunchMitVector() uint64 {
	if x != nil {
		return x.LaunchMitVector
	}
	return 0
}

func (x *Report) GetCurrentMitVector() uint64 {
	if x != nil {
		return x.CurrentMitVector
	}
	return 0
}
...
type ServicesManifestEntry struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ServicesManifestEntry) Reset() {
	*x = ServicesManifestEntry{}
	if protoimpl.UnsafeEnabled {
...
func (x *ServicesManifestEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ServicesManifestEntry) ProtoMessage() {}

func (x *ServicesManifestEntry) ProtoReflect() protoreflect.Message {
	mi := &file_sevsnp_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ServicesManifestEntry.ProtoReflect.Descriptor instead.
func (*ServicesManifestEntry) Descriptor() ([]byte, []int) {
	return file_sevsnp_proto_rawDescGZIP(), []int{3}
}

func (x *ServicesManifestEntry) GetGuid() string {
	if x != nil {
		return x.Guid
	}
	return ""
...
func (x *ServicesManifestEntry) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
type ServicesManifest struct {
	...
	Services []*ServicesManifestEntry `protobuf:"bytes,1,rep,name=services,proto3" json:"services,omitempty"`
}

func (x *ServicesManifest) Reset() {
	*x = ServicesManifest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sevsnp_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ServicesManifest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ServicesManifest) ProtoMessage() {}

func (x *ServicesManifest) ProtoReflect() protoreflect.Message {
	mi := &file_sevsnp_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ServicesManifest.ProtoReflect.Descriptor instead.
func (*ServicesManifest) Descriptor() ([]byte, []int) {
	return file_sevsnp_proto_rawDescGZIP(), []int{4}
}

func (x *ServicesManifest) GetServices() []*ServicesManifestEntry {
	if x != nil {
		return x.Services
	}
	return nil
...
type Attestation struct {
	...
	ServicesManifest *ServicesManifest `protobuf:"bytes,4,opt,name=services_manifest,json=servicesManifest,proto3" json:"services_manifest,omitempty"`
}

func (x *Attestation) Reset() {
	*x = Attestation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sevsnp_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Attestation) Descriptor() ([]byte, []int) {
	return file_sevsnp_proto_rawDescGZIP(), []int{5}
}
...
func (x *Attestation) GetServicesManifest() *ServicesManifest {
	if x != nil {
		return x.ServicesManifest
	}
	return nil
}
...
var file_sevsnp_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa7, 0x08, 0x0a, 0x06, 0x52, 0x65, 0x70, 0x6f, 0x72,
	...
	,
	...
	,
	...
	,
	...
	,
}
...
var file_sevsnp_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_sevsnp_proto_goTypes = []interface{}{
	...
	(*ServicesManifestEntry)(nil),  // 4: sevsnp.ServicesManifestEntry
	(*ServicesManifest)(nil),       // 5: sevsnp.ServicesManifest
	(*Attestation)(nil),            // 6: sevsnp.Attestation
	nil,                            // 7: sevsnp.CertificateChain.ExtrasEntry
	(*wrapperspb.UInt32Value)(nil), // 8: google.protobuf.UInt32Value
}
var file_sevsnp_proto_depIdxs = []int32{
	7, // 0: sevsnp.CertificateChain.extras:type_name -> sevsnp.CertificateChain.ExtrasEntry
	0, // 1: sevsnp.SevProduct.name:type_name -> sevsnp.SevProduct.SevProductName
	8, // 2: sevsnp.SevProduct.machine_stepping:type_name -> google.protobuf.UInt32Value
	4, // 3: sevsnp.ServicesManifest.services:type_name -> sevsnp.ServicesManifestEntry
	1, // 4: sevsnp.Attestation.report:type_name -> sevsnp.Report
	2, // 5: sevsnp.Attestation.certificate_chain:type_name -> sevsnp.CertificateChain
	3, // 6: sevsnp.Attestation.product:type_name -> sevsnp.SevProduct
	5, // 7: sevsnp.Attestation.services_manifest:type_name -> sevsnp.ServicesManifest
...
func file_sevsnp_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sevsnp_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ServicesManifestEntry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sevsnp_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ServicesManifest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sevsnp_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
