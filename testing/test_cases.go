...
var vlekWithManifestProto = `
version: 2
policy: 0xa0000
signature_algo: 1
signer_info: 4
report_data: ''
family_id: '\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
image_id: '\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
measurement: '\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
host_data: '\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
...
var manifestData = make([]byte, 312)
var manifestProto = `services: {
  guid: 'c476f1eb-0123-45a5-9641-b4e7dde5bfe3',
  data: ''
}`
...
func CreateRawReport(opts *TestReportOptions) [labi.SnpReportRespReportSize]byte {
	...
	if opts.UseSVSM {
		hash := sha512.Sum512(append(reportData, opts.Manifest...))
		reportData = hash[:]
	}
...
func createRawManifest() ([]byte, error) {
	manifest := abi.ServicesManifest{
		Entries: []abi.ServiceEntry{
			{
...
func TestCases() []TestCase {
	...
	manifest, _ := createRawManifest()
	vlekWithManifestRaw := CreateRawReport(&TestReportOptions{
		ReportData: userZeros15[:],
		SignerInfo: abi.SignerInfo{SigningKey: abi.VlekReportSigner},
		Manifest:   manifest,
		UseSVSM:    true,
	})
	return []TestCase{
		...
		{
			Name:          "zeros VLEK with manifest",
			Input:         userZeros15,
			Output:        vlekWithManifestRaw,
			OutputProto:   vlekWithManifestProto,
			EK:            KeyChoiceVlek,
			Manifest:      manifest,
...
func TcDevice(tcs []TestCase, opts *DeviceOptions) (*Device, error) {
	...
	manifestResponses := map[string]any{}
	for _, tc := range tcs {
		key := hex.EncodeToString(tc.Input[:])
		responses[key] = &GetReportResponse{
			Resp:     labi.SnpReportRespABI{Data: tc.Output},
			FwErr:    tc.FwErr,
			EsResult: tc.EsResult,
		}
		if len(tc.Manifest) > 0 {
			manifestResponses[key] = tc.Manifest
		}
	}
